...
func main() {
	vec1 := mylib.NewVector2D(1.32, 2.65)
	vec2 := mylib.NewVector2D(3.123, 4.43)
	vec3 := mylib.NewVector2D(5.09, 6)

	vec1P := mylib.NewVector2DPolarA(vec1)
	vec2P := mylib.NewVector2DPolarA(vec2)
	vec3P := mylib.NewVector2DPolarA(vec3)

	vec13d := mylib.NewVector3dD(vec1, 0)
	vec23d := mylib.NewVector3dD(vec2, 0)
	vec33d := mylib.NewVector3dD(vec3, 0)
	...
	/* DZIEDZICZENIE
	vec1i := mylib.NewVector2D(1, 2)
	vec2i := mylib.NewVector2D(3, 4)
	vec3i := mylib.NewVector2D(5, 6)

	vec1Pi := mylib.NewVector2DPolarI(vec1i)
	vec2Pi := mylib.NewVector2DPolarI(vec2i)
	vec3Pi := mylib.NewVector2DPolarI(vec3i)

	vec13di := mylib.NewVector3dI(vec1i, 0)
	vec23di := mylib.NewVector3dI(vec2i, 0)
	vec33di := mylib.NewVector3dI(vec3i, 0)
